...
export function DateTimeFormat(sFormat, date) {
  console.log('DateTimeFormat1',date);
  if (!(date instanceof Date))
   date = new Date();
  window.dateDate=date;
console.log('DateTimeFormat2',date);
  ...
  return sFormat.replace(/%[a-z]/gi, function(sMatch) {
    var newADays=aDays[nDay];
    var newAMonths=aMonths[nMonth];
    console.log('newADays',newADays,newAMonths,'separate',aDays,nDay,aMonths,nMonth);
    return (({
      '%a': newADays.slice(0,3),
      '%A': newADays,
      '%b': newAMonths.slice(0,3),
      '%B': newAMonths,
      '%c': date.toUTCString(),
